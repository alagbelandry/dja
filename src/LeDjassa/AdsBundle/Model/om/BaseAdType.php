...
abstract class BaseAdType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LeDjassa\\AdsBundle\\Model\\AdTypePeer';
     ...
     * @return AdType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AdTypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = AdTypePeer::NAME;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = AdTypePeer::CODE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = AdTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AdType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AdTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `ad_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AdTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AdTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AdType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AdType'][$this->getPrimaryKey()] = true;
        $keys = AdTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getCode(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdTypePeer::ID)) $criteria->add(AdTypePeer::ID, $this->id);
        if ($this->isColumnModified(AdTypePeer::NAME)) $criteria->add(AdTypePeer::NAME, $this->name);
        if ($this->isColumnModified(AdTypePeer::CODE)) $criteria->add(AdTypePeer::CODE, $this->code);
    ...
    {
        $criteria = new Criteria(AdTypePeer::DATABASE_NAME);
        $criteria->add(AdTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AdType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AdType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this AdType is new, it will return
     ...
     * Otherwise if this AdType is new, it will return
     * an empty collection; or if this AdType has previously
     * been saved, it will retrieve related Ads from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AdType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
