...
abstract class BaseArea extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'LeDjassa\\AdsBundle\\Model\\AreaPeer';
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = AreaPeer::SLUG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = AreaPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isColumnModified(AreaPeer::SLUG) && $this->getSlug()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AreaPeer::SLUG)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AreaPeer::SLUG)) $criteria->add(AreaPeer::SLUG, $this->slug);
    ...
    {
        $this->citiesScheduledForDeletion = $this->getCities(new Criteria(), $con)->diff($cities);

        foreach ($this->citiesScheduledForDeletion as $cityRemoved) {
            $cityRemoved->setArea(null);
        }
    ...
    protected function makeSlugUnique($slug, $separator = '-', $increment = 0)
    {
        ...
        $slugAlreadyExists = AreaQuery::create()
            ->filterBySlug($slug2)
            ->prune($this)
            ->count();
