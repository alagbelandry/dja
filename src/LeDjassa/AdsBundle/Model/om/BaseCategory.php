...
abstract class BaseCategory extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'LeDjassa\\AdsBundle\\Model\\CategoryPeer';
    ...
    /**
     * The value for the category_type_id field.
     * @var        int
     */
    ...
    /**
     * Get the [category_type_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [category_type_id] column.
     *
     * @param int $v new value
     * @return Category The current object (for fluent API support)
     */
    public function setCategoryTypeId($v)
    {
        ...
        if ($this->category_type_id !== $v) {
            $this->category_type_id = $v;
            $this->modifiedColumns[] = CategoryPeer::CATEGORY_TYPE_ID;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCategoryType !== null && $this->category_type_id !== $this->aCategoryType->getId()) {
            $this->aCategoryType = null;
        }
    } // ensureConsistency
