...
use LeDjassa\AdsBundle\Model\map\CategoryTableMap;
...
abstract class BaseCategoryPeer
{
    ...
    const OM_CLASS = 'LeDjassa\\AdsBundle\\Model\\Category';
    ...
    public static function doCountJoinCategoryType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CategoryPeer::CATEGORY_TYPE_ID, CategoryTypePeer::ID, $join_behavior);
