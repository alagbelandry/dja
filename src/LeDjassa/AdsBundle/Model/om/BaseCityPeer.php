...
use LeDjassa\AdsBundle\Model\map\CityTableMap;
...
abstract class BaseCityPeer
{
    ...
    const OM_CLASS = 'LeDjassa\\AdsBundle\\Model\\City';
    ...
    public static function doCountJoinArea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CityPeer::AREA_ID, AreaPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of City objects pre-filled with their Area objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinArea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (City) to $obj2 (Area)
                $obj2->addCity($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (City) to the collection in $obj2 (Area)
                $obj2->addCity($obj1);
