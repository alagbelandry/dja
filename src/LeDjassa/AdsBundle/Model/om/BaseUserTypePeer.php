...
use LeDjassa\AdsBundle\Model\map\UserTypeTableMap;
...
abstract class BaseUserTypePeer
{
    ...
    const OM_CLASS = 'LeDjassa\\AdsBundle\\Model\\UserType';

    /** the related TableMap class for this table */
    const TM_CLASS = 'UserTypeTableMap';
     ...
     * e.g. UserTypePeer::$fieldNames[UserTypePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Code', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'code', ),
        BasePeer::TYPE_COLNAME => array (UserTypePeer::ID, UserTypePeer::TITLE, UserTypePeer::CODE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. UserTypePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Code' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'code' => 2, ),
        BasePeer::TYPE_COLNAME => array (UserTypePeer::ID => 0, UserTypePeer::TITLE => 1, UserTypePeer::CODE => 2, ),
    ...
    {
        $toNames = UserTypePeer::getFieldNames($toType);
        $key = isset(UserTypePeer::$fieldKeys[$fromType][$name]) ? UserTypePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(UserTypePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, UserTypePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return UserTypePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(UserTypePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(UserTypePeer::DATABASE_NAME);
     ...
     *
     * @param      UserType $obj A UserType object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            UserTypePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(UserTypePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(UserTypePeer::$instances[$key])) {
                return UserTypePeer::$instances[$key];
            }
        }
    ...
    {
        UserTypePeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to user_type
    ...
    {
        $key = UserTypePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = UserTypePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + UserTypePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = UserTypePeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(UserTypePeer::DATABASE_NAME)->getTable(UserTypePeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseUserTypePeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseUserTypePeer::TABLE_NAME)) {
    ...
    /**
     * Performs an UPDATE on the database, given a UserType or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(UserTypePeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(UserTypePeer::ID);
            $value = $criteria->remove(UserTypePeer::ID);
            if ($value) {
                $selectCriteria->add(UserTypePeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(UserTypePeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(UserTypePeer::TABLE_NAME, $con, UserTypePeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            UserTypePeer::clearInstancePool();
            UserTypePeer::clearRelatedInstancePool();
            $con->commit();
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(UserTypePeer::DATABASE_NAME, UserTypePeer::TABLE_NAME, $columns);
    }
...
//
BaseUserTypePeer::buildTableMap();
